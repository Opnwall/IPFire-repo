...
$tr{'reports dnsfw stat lists d'} = 'Listes DNS Firewall activées';
$tr{'reports dnsfw donut title'} = 'Blocages par liste';
$tr{'reports dnsfw donut sub'} = 'Répartition par liste DNS Firewall (TOP 6)';
...
$tr{'reports dnsfw sec listactivity'} = 'Activité par liste DNS Firewall';
...
$tr{'reports cat custom'} = 'Personnalisée';
$tr{'reports url stat porn d'} = 'Contenu pour adultes';
$tr{'reports url stat ads d'} = 'Publicité et traqueurs';
$tr{'reports url sec bycategory'} = 'Blocages par catégorie';
$tr{'reports url threat desc'} = 'Accès à des contenus malveillants ou de phishing bloqués par le filtre.';
$tr{'reports url custom note'} = 'Les listes blanches personnalisées autorisent le trafic et ne sont pas journalisées comme blocages.';
$tr{'reports url sec threats'} = 'Menaces bloquées';
$tr{'reports url sec nothreat'} = 'Aucune menace détectée';
$tr{'reports url sec nothreat d'} = 'Aucun blocage de malware ni de phishing durant la période.';
$tr{'reports fw stat srcips'} = 'Sources uniques';
$tr{'reports fw stat srcips d'} = 'IP sources distinctes';
$tr{'reports fw stat ports'} = 'Ports uniques';
$tr{'reports fw stat ports d'} = 'Ports de destination visés';
$tr{'reports fw drops donut title'} = 'Blocages par type';
$tr{'reports fw drops donut sub'} = 'Répartition par type de rejet';
$tr{'reports fw type input'} = 'Entrant (INPUT)';
$tr{'reports fw type forward'} = 'Transfert (FORWARD)';
$tr{'reports fw type output'} = 'Sortant (OUTPUT)';
$tr{'reports fw type hostile'} = 'Réseaux hostiles';
$tr{'reports fw type ctinvalid'} = 'Connexion invalide';
$tr{'reports fw type newnotsyn'} = 'TCP sans SYN';
$tr{'reports fw type spoofed'} = 'Usurpation (Martian)';
$tr{'reports fw type portscan'} = 'Balayage de ports';
$tr{'reports no services configured'} = 'Aucun service configuré pour générer des rapports';
# <<< reports auto-i18n <<<
